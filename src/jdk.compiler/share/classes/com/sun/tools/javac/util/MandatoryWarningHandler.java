...
public class MandatoryWarningHandler {
     ...
     */
    public MandatoryWarningHandler(Log log, Lint lint, Source source, boolean enforceMandatory, LintCategory lc) {
        this(log, lint, source, enforceMandatory, lc, null);
    }
     ...
     */
    public MandatoryWarningHandler(Log log, Lint lint, Source source, boolean enforceMandatory, LintCategory lc, String prefix) {
        this.log = log;
        this.lint = lint;
        this.source = source;
