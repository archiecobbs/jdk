 ...
 *************************************************************************/
    ...
    public void visitClassDef(JCClassDecl tree) {
        ...
        // initializer code to all super() invocations to initialize it
        if (currentClass.hasOuterInstance() && shouldEmitOuterThis(currentClass)) {
            tree.defs = tree.defs.prepend(otdef);
            enterSynthetic(tree.pos(), otdef.sym, currentClass.members());

           for (JCTree def : tree.defs) {
                if (TreeInfo.hasConstructorCalls(def, names._super)) {
    ...
    private void visitMethodDefInternal(JCMethodDecl tree) {
        if (tree.name == names.init &&
            ...
            // Determine whether this constructor has any super() invocations.
            boolean invokesSuper = TreeInfo.hasConstructorCalls(tree, names._super);
            ...
            // Prepend initializers in front of all super() calls
            if (added.nonEmpty()) {
