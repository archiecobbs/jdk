 ...
 *************************************************************************/
    ...
    /** Insert instance initializer code into constructors prior to each super() call.
    ...
    void normalizeMethod(JCMethodDecl md, List<JCStatement> initCode, List<TypeCompound> initTAs) {
        if (md.name == names.init && TreeInfo.hasConstructorCalls(md, names._super)) {
            // We are seeing a constructor that has one or more super() calls.
            // Find all super() invocations and append the given initializer code.
