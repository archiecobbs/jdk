...
public class SuperInitGood {
    ...
    // Explicit this()/super() with branches
    static class Test4 extends Test2<Object> {
        Test4() {
            if ((new Object().hashCode() & 1) != 0) {
                super();
            } else if ((new Object().hashCode() & 1) != 0) {
                super("abc");
            } else if ((new Object().hashCode() & 1) != 0) {
                try {
                    new Object().hashCode();
    ...
    public static class Test18 extends AtomicReference<Object> {
        ...
        public Test18(boolean fail) throws MyException {
            for (Object obj = new Object(); true; obj = new Object()) {
    ...
    public static void main(String[] args) {
        ...
        assert t14.x == 1 && t14.y == -1 && t14.z == 13;
        t14 = new Test14(7);
